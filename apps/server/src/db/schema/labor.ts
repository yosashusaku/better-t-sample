...
import { project, projectMonth, projectMember } from "./project"
...
export const employeeSalary = pgTable("employee_salary", {
  ...
  standardWorkHoursPerMonth: decimal("standard_work_hours_per_month", { precision: 6, scale: 2 }).default("160"), // 160h/month
